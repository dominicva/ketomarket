export default function ProductPageSkeleton() {
  return (
    <div className="m-auto mt-4 max-w-xl px-12 py-10">
      ...
      <div className="mb-4 h-4 w-14 animate-pulse rounded bg-gray-300"></div>
      <div className="mb-1 mt-4 h-48 w-full animate-pulse rounded bg-gray-300"></div>
      <div className="mt-8">
